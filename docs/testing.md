...
Die visuelle Nacharbeit ergänzt Regressionen für tatsächliche gedrehte Glyphenmaße innerhalb der Topflächen, beleuchtete Legenden ohne Outline, nach außen gerichtete Kappenseiten und den Wolkenhimmel ohne übermalenden Hintergrundnebel. Die eigene Bildprüfung beurteilt zusätzlich Kappenform, integriertes Druckbild und Himmel-/Timer-Hierarchie gegen den lesbaren Original-Mock; Geometrietests allein gelten nicht als visueller Nachweis.
