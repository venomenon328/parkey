...
| P-006 | Lokale Ranglisten je Strecken-/Regelidentität in P1c implementiert; Review/Abnahme noch offen | [P1c-Vertrag](p1c-local-results.md); keine automatische Windows-/Web-Synchronisierung. Gleichstands-/Aufbewahrungsparameter sind vorläufige Arbeitsfestlegungen dieses Pakets, keine neue ausdrückliche Produktentscheidung. |
