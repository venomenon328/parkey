...
| P-007 | Automatische Third-Person-Rückkamera mit lesbaren Nachbarn und rechtzeitig sichtbaren Verzweigungen | Kontinuität ist abgenommen; P2a implementiert im Draft die Vorschau beider Routen und die Beschriftungsumstellung. Reale P2a-Spielabnahme bleibt offen. |
| P-008 | Zuerst handgebaute Teststrecken, danach modulbasierte Seed-Generierung | P2a liefert kleine getestete Datenverträge, nicht den Generator. Erst echte Spielversuche können Bausteine für P3a empfehlen oder verwerfen. |
...
**P2a / Issue #5:** Auf `codex/p2a-route-decisions` technisch implementiert und bis Review sowie Abnahme Draft. Der Referenzkurs erprobt zwei asymmetrische Entscheidungen mit expliziten Ports, variierenden Rechteckgrundflächen und gemeinsamen Finale. Die QWERTZ-Folgen sind transparente Hypothesen, keine Ergonomieaussagen; die Messung bleibt je Versuch im Speicher. Große P1b-Callouts sind entfernt, Hauptbeschriftungen auf den Tile-Oberflächen gedreht und die Kamera fokussiert vor Entscheidungen beide Vorschaufelder. Reale Windows-/Web-Kameraprüfung und menschliche Spielversuche mit mindestens zwei Tippmethoden bleiben erforderlich; erst danach Bausteine für #7 empfehlen. Zielhardware, Auflösung und Leistungsbudget gehören weiter zu #6. Keine Generator-, Asset-, Höhen-, Sprung-/Brücken- oder Polygonarbeit ist mitbeauftragt.
...
- 2026-09-06: P2a / #5 implementiert zwei Datenverträge je Entscheidung, einen 30-Feld-Referenzkurs, oberflächengebundene 90°-Beschriftungen, vorausschauende Kamera und flüchtige Abschnittsmessung. Die automatischen Nachweise sind kein Ersatz für die offene menschliche P2a-Spielabnahme oder die weiterhin offene physische P1b-Chrome-Eingabeabnahme.
