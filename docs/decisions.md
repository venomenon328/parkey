...
## Bestätigtes P2b-Briefing (Issue #6, 2026-09-06)
...
Die vorausgegangene verbindliche Nacharbeit in [Issue #6](https://github.com/venomenon328/parkey/issues/6#issuecomment-5560268276) präzisiert D-025/D-027: substanzielle Asset-, Material-, Licht-/Himmel- und Kompositionsqualität; versionierte lizenzierte Schriften für Legenden und Timer. Statussymbole (Punkt, Haken, Raute) entfallen aus der Spieleransicht; Material/Farbe, Hub und Figur vermitteln den unveränderten Statusvorrang. Original-Mikrosekunden bleiben ausschließlich intern sowie in F3/Evidenz, die normale Ergebnis-/Top-10-Ansicht zeigt `MM:SS.mmm`. Dies ersetzt die frühere P1c-Rohzeitanzeige und Symbolgestaltung. Präsentationsseitiges Kameratuning gemäß D-020/D-021 ist erlaubt, wenn beide Alternativen vor jeder Entscheidung und die direkten Nachbarn lesbar bleiben. Die ergänzende Nutzerentscheidung vom 2026-09-06 verlangt einen möglichst texturierten, zusammenhängenden Werkstattboden unter den seitlichen Stationen statt schwebender Möbel. Freie Start-/Zielschrift und der Boden-Schriftzug entfallen; die Beschriftung am eigentlichen Zielportal bleibt. Der Boden ist reine Kulisse unterhalb der Strecke. D-026/D-028 sowie P1-/P2a-Kern und Identität bleiben unverändert. Umsetzung und subjektive Nutzerabnahme sind getrennt; Vertrag und Nachweise: [P2b-Visual-Slice](p2b-visual-slice.md).

Die neueste verbindliche [Fidelity-Runde](https://github.com/venomenon328/parkey/issues/6#issuecomment-5561815307) auf Basis `b236f17` präzisiert D-025: kohärente Tastatur-Werkstatt mit bewusst gestalteten Funktionsbereichen, illustrativer Licht-/Farbregie und möglichst enger Annäherung der Figur an den Mock, einschließlich Grundformen, kindlicher Proportionen, Kopf, Frisur, Kleidung und Schuhen. Der lesbare Mock wurde für diesen Lauf erneut extern angehängt; Reparatur, Encoding und erneuter Repo-Import bleiben ausgeschlossen. Die ausführliche Pacing-Untersuchung ist für diese Iteration abgeschlossen. D-028 und die normale Konfiguration bleiben erhalten; nach visuellen Änderungen genügen reale Windows-/Web-Release-Sanity-Werte, keine erneute PresentMon-/ETW-/Monitor-/Treiberforensik. Versionierte Diagnosen werden auf finale Messwerte und einen knappen Ursachennachweis reduziert. Kern-, Identitäts-, Status-, Hub- und Persistenzverträge sowie offene Nutzerabnahme bleiben unverändert.

Ergänzende Nutzerentscheidung in diesem Lauf: Die Tisch-/Arbeitsplatten der Stationen erhalten eine **andere Textur als der Boden**. Die Materialtrennung ist kosmetisch; Längsmaserung und unveränderte Streckenidentität bleiben verbindlich.
...
- 2026-09-06: Nutzer verlangt eigene Arbeitsplattentextur der Stationen, getrennt von der Bodentextur.
- 2026-09-06: Neuester #6-Auftrag priorisiert Image Quality, kohärentes Werkstatt-Set und enge Mock-Figurenannäherung. Weitere Pacing-Forensik entfällt in dieser Runde zugunsten normaler Performance-Sanity-Prüfungen; experimentelle Evidenz wird gezielt bereinigt.
- 2026-09-06: Der Nutzer spielt auf beiden angeschlossenen Monitoren (144 Hz und 60 Hz). Die normale Windows-Pacing-Prüfung muss deshalb beide Ausgaben abdecken; ein Erfolg allein am schnelleren Monitor schließt den technischen Auftrag nicht ab.
- 2026-09-06: Ergänzende Nutzerentscheidung im laufenden P2b-Fidelity-Pass: Die Holzmaserung folgt der Längsrichtung der dargestellten Bretter. Farb-, Normal- und Rauheitsabbildung werden gemeinsam ausgerichtet; keine Änderung der Strecke.
- 2026-09-06: Die große Näherungsrunde aus #6 ersetzt die bisherige Symbol-/Rohzeitdarstellung und erlaubt Kamera-/Kompositionstuning unter den bestehenden Lesbarkeitsbedingungen. Explizite Schriften und wiederholter realer 1440p-Vergleich gegen Mock und `2655146` sind Pflicht; keine neue Mechanik oder Abnahme.
