...
| P-007 | Automatische perspektivische Third-Person-Rückansicht gemäß D-021; lesbare Nachbarn und rechtzeitig sichtbare Verzweigungen | Die bisherigen direkten Kameraresets sind nachgearbeitet. Die nächste Buchstabenreihe wird laut Nutzer noch von der Figur verdeckt; finale Kameraparameter und menschliche Abnahme bleiben offen. |
...
| P-009 | Unabhängige logische Position und aufholende visuelle Bewegung; keine unbeschränkte Animationswarteschlange | Endliche Wegpunktgrenze und Aufholbudgets sind implementiert, aber das Nachlaufen wurde vom Nutzer zu `9641675` als zu träge beurteilt. Engere Kopplung an den Tipprhythmus ist nachzuarbeiten; D-003/D-012/D-020 bleiben verbindlich. |
...
**P1b / Issue #3:** `9641675` behebt die bisherigen technischen Ursachen für enge Asttrennung, Kamera-Snaps und fehlenden Canvas-Rückfokus. Besuchsstatus ist vorhanden. CI `33982696600` einschließlich 317 Gesamtassertions und beider Exporte ist erfolgreich. Die neue Nutzerprüfung meldet aber zu träges Nachlaufen und verdeckte nächste Buchstaben; D-022 präzisiert die bislang offene Palette. Aktueller Review und [p1b-playability.md](p1b-playability.md) begrenzen die verbleibende Nacharbeit. Kein Merge und keine vollständige manuelle Abnahme. Escape, Timing, Fehlerfrist und Paketgrenzen bleiben unverändert.
