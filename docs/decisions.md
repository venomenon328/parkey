...
| P-006 | Zunächst lokale Ranglisten je Strecken-/Regelidentität, kein Online-Dienst | Lieferumfang von P1c; keine automatische Windows-/Web-Synchronisierung. |
...
**P1c / Issue #4:** Nächstes Paket; lokale Bestzeiten und Ergebnisschirm. Gleichstands-/Aufbewahrungsvertrag ist vor bzw. mit der Paketvorbereitung konkret festzulegen.
