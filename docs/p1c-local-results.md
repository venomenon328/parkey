...
| Anzeige | Standard `MM:SS.mmm`, ganzzahlig abgeschnitten wie im vorhandenen HUD. Aktueller Lauf und Top 10 zeigen zusätzlich die exakte Mikrosekundenzeit; dadurch bleiben verschiedene Originalzeiten mit gleicher Millisekundenanzeige und unterschiedlichen Rängen nachvollziehbar. Keine Präzision vortäuschen oder Rohzeit überschreiben. |
