...
Historisch war `scripts/course/handcrafted_course.gd` die einzige Quelle des P1b-26-Feld-Kurses: Der gesamte ebene Kurs war um 18° gedreht; die 2,0 Einheiten tiefen Paralleläste lagen bei lokal z = ±2,15 und die 6,3 Einheiten tiefen Gabelungs-/Zusammenführungsfelder schlossen beide Äste explizit an. Der aktive Quellkurs wurde in P2a durch den 30-Feld-Referenzkurs mit zwei Entscheidungen ersetzt; dessen Vertrag steht in [p2a-route-decisions.md](p2a-route-decisions.md). Dieser historische P1b-Nachweis wird dadurch nicht als aktueller Kursstand ausgegeben.
