...
Forward+ verwendet 4× MSAA, einen weich gefilterten Schattenwerfer, schattenloses Fülllicht, ACES und begrenztes SSAO (Radius 0,85, Intensität 1,35). Compatibility erhält dieselbe Geometrie, Schriften, Material-/Hubsignale und den Himmel ohne Schatten/SSAO/MSAA und mit linearem Tonemapping. Kein Glow, DOF, SSR, volumetrischer Nebel oder Partikelsystem. Eigene deterministische 128×128-Rauheits-/Normaltexturen und eine 256×256-Mattennormalmap geben dezente Oberflächendetails.
