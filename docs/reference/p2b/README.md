...
- Visueller Qualitätsmaßstab für die nächste Fidelity-Runde: überzeugende Keycap- und Materialwirkung, hochwertigere Umgebung/Modelle/Texturen, bessere Himmel-/Lighting-/Shader-/Bildqualität sowie eine sichtbar detailliertere und stilistisch integrierte Spielfigur. HUD/Timer dürfen weiter verfeinert werden, sind aber gegenüber Welt-/Bild-/Charakterqualität nachgeordnet.
- Ergänzende Nutzerentscheidung: texturierter Boden unter den Werkstattstationen, tragfähige Auflage der Dekoration und keine freien Start-/Ziel- oder Boden-Schriftzüge; Portalbeschriftung bleibt.
