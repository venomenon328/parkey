...
| HUD, Ergebnisgestaltung, Stoppuhr-Symbol | Eigener Szenen-/UI-Code in `workshop_hud.gd` und Vektorzeichenbefehle in `stopwatch_icon.gd` | Nutzer-Mock nur qualitative Orientierung; kein Bildasset daraus übernommen. |
| Wolkenpanorama | Eigene Farbkomposition und sphärische FastNoiseLite-Abtastung in `workshop_world.gd`, einmalig 1024×512 Pixel | Kein heruntergeladenes HDRI/Bild; FastNoiseLite ist Bestandteil der vorhandenen Godot-Laufzeit und ihrer Drittanbieterhinweise. |
