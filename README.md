...
**P2a / Issue #5 ist auf `codex/p2a-route-decisions` implementiert und bleibt bis Review sowie realer Spielabnahme Draft.** Der 30-Feld-Referenzkurs enthält zwei handgestaltete Entscheidungen mit gemeinsamer Finale, datenbasierte Abschnittsports/-geometrie, vorausschauende Kamera, auf der Keycap gedrehte Hauptbeschriftungen und eine rein lokale Abschnittsmessung. Die großen weißen P1b-Callouts sind entfernt. Details: [P2a-Routenentscheidungen](docs/p2a-route-decisions.md). Die physische P1b-Chrome-Eingabeabnahme und die menschliche P2a-Spielabnahme bleiben offen.
...
**P2a / Issue #5 ist technisch implementiert und im Draft-PR.** Automatisierte Verträge prüfen die beiden Entscheidungen, Ports/Geometrie, alle vier Routenkombinationen, Messung, Kamera-Vorschau und die Beschriftungsumstellung. Vor P2b/P3a bleiben Review, reale Windows-/Web-Kameraprüfungen und die menschliche P2a-Spielabnahme offen. Erst deren Ergebnisse können Bausteine für Generator oder Gestaltung empfehlen.
