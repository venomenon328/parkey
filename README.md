...
**P1b / Issue #3 ist im Draft-PR #13 implementiert und nach Review 5121935189 technisch nachgearbeitet, aber noch nicht vollständig abgenommen.** Der reguläre Einstieg ist ein validierter 26-Feld-Handparcours mit zwei klar getrennten Routen, Rückwegen, Besuchs-/Nachbarstatus, Figur, kontinuierlicher Rückkamera, Timer, Fehlerfeedback, Quick Restart und minimaler Escape-Rückmeldung. Die echte Suite `integration` prüft Szenen-, Maus-/UI-, Kern- und Darstellungsverdrahtung. Lokale Windows-/Chrome-Exportläufe mit OS-synthetischen Eingaben sind bestanden; physische Tastatur-/Nutzerabnahme, CI und Re-Review bleiben eigenständige Gates. Dauerhafte Ranglisten und Generator fehlen weiterhin planmäßig.
