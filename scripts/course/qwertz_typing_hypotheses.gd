...
const KEY_DATA := {
	...
	"L": {"hand": "right", "finger": "ring", "row": "home"}, "Y": {"hand": "right", "finger": "index", "row": "top"},
	...
	"T": {"hand": "left", "finger": "index", "row": "top"}, "Z": {"hand": "left", "finger": "little", "row": "bottom"},
	"V": {"hand": "left", "finger": "index", "row": "bottom"}, "B": {"hand": "left", "finger": "index", "row": "bottom"},
	"N": {"hand": "right", "finger": "index", "row": "bottom"}, "M": {"hand": "right", "finger": "index", "row": "bottom"},
}
...
static func describe(sequence: String) -> Dictionary:
	...
	for index in letters.length():
		...
		var key: Dictionary = KEY_DATA.get(letter, {})
		if key.is_empty():
